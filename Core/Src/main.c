...
/* USER CODE BEGIN PM */
uint32_t lastTime01;
uint32_t Settime01 = 100; // กำหนดเวลาในการกระพริบ PA6 ทุกๆ 100 ticks (2 ms) , จากการคำนวณในรูป
uint32_t lastTime02;
uint32_t Settime02 = 1500;  // กำหนดเวลาในการอ่านค่าปุ่มทุกๆ 1500 ticks (20 ms)

uint32_t count = 0; // นับเวลาโดยใช้ Timer
